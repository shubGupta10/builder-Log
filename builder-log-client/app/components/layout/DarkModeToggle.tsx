...
export function DarkModeToggle() {
    ...
    if (!mounted) {
        return <div className="w-[50px] h-[26px]" />
    }
    ...
    return (
        <button
            onClick={toggleTheme}
            className={cn(
                "relative inline-flex h-[26px] w-[50px] shrink-0 cursor-pointer items-center rounded-full border-2 transition-colors duration-500 ease-in-out focus:outline-none focus-visible:ring-1 focus-visible:ring-ring focus-visible:ring-offset-1 select-none",
